...
class _AboutScreenState extends State<AboutScreen> {
  ...
  // FEATURE 1: Real Play Store review
    ...
    try {
      ...
      if (await inAppReview.isAvailable()) {
        ...
        await inAppReview.openStoreListing(
          appStoreId: 'com.example.sleep_tracker',
        );
      }
    } catch (e) {
      _showRateDialog(context);
  ...
  // FEATURE 2: Toggle notifications
  ...
  Future<void> _emailWeeklyReport() async {
    ...
    if (email.isEmpty) {
      _showSnack('No email found. Please update your profile.', const Color(0xFFFF6B6B));
      return;
    }

    // Build sleep summary
    final buffer = StringBuffer();
    buffer.writeln('SleepWell - Weekly Sleep Report');
    buffer.writeln('================================');
    buffer.writeln('Name: $name | Age: $age | Gender: $gender');
    buffer.writeln('');
    buffer.writeln('Last 7 Days Sleep Log:');
    buffer.writeln('');
    ...
    for (int i = 6; i >= 0; i--) {
      ...
      if (val != null) {
        ...
        if (parts.length == 2) {
          ...
          total += hours;
          count++;
          buffer.writeln('$dayName: ${hours.toStringAsFixed(1)} hours');
        }
      } else {
        buffer.writeln('$dayName: Not logged');
      }
    }

    buffer.writeln('');
    if (count > 0) {
      buffer.writeln('Average: ${(total / count).toStringAsFixed(1)} hrs/night');
    }
    buffer.writeln('');
    buffer.writeln('Stay healthy! - SleepWell App');

    final subject = Uri.encodeComponent('My SleepWell Weekly Report');
      ...
      child: Column(
        children: [
          Text('Your Profile', style: GoogleFonts.poppins(
              fontSize: R.font(15), fontWeight: FontWeight.bold,
  ...
  Widget _initialsWidget(String initials) => Container(
    ...
    child: Center(child: Text(initials, style: GoogleFonts.poppins(
        fontSize: R.font(32), fontWeight: FontWeight.bold, color: Colors.white))),
  );

  // FEATURE 2: Notifications card
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Sleep Reminders', style: GoogleFonts.poppins(
                        fontSize: R.font(15), fontWeight: FontWeight.bold,
                        color: AppTheme.textPrimary)),
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: GoogleFonts.poppins(
                          fontSize: R.font(11), color: AppTheme.textPrimary,
                          height: 1.6),
                    ),
                  ),
                ],
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Email My Weekly Report', style: GoogleFonts.poppins(
                      fontSize: R.font(15), fontWeight: FontWeight.bold,
                      color: AppTheme.textPrimary)),
                  Text(
      ...
      child: Column(
        children: [
          ...
          Text('"Built with passion to help the world sleep better"',
              ...
              style: GoogleFonts.poppins(fontSize: R.font(12),
  ...
  Widget _devBadge(String label) => Container(
    ...
    child: Text(label, style: GoogleFonts.poppins(
        fontSize: R.font(12), color: Colors.white)),
  );
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('SleepWell', style: GoogleFonts.poppins(
                        fontSize: R.font(18), fontWeight: FontWeight.bold,
                        color: AppTheme.textPrimary)),
  ...
  Widget _buildRateUsCard(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        width: double.infinity, padding: EdgeInsets.all(R.sp(18)),
        decoration: BoxDecoration(
          color: AppTheme.cardColor,
          borderRadius: BorderRadius.circular(R.sp(24)),
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Rate on Play Store', style: GoogleFonts.poppins(
                      fontSize: R.font(15), fontWeight: FontWeight.bold,
                      color: AppTheme.textPrimary)),
                  Text('Opens official Google Play review',
                      style: GoogleFonts.poppins(
                          fontSize: R.font(11), color: AppTheme.textSecondary)),
                ],
              ),
  ...
  Widget _buildShareCard(BuildContext context) {
    return GestureDetector(
      onTap: () async {
        try {
          final uri = Uri.parse(
              'https://play.google.com/store/apps/details?id=com.example.sleep_tracker');
          if (await canLaunchUrl(uri)) {
            await launchUrl(uri, mode: LaunchMode.externalApplication);
          }
        } catch (e) {
          _showSnack('Sharing coming soon!', AppTheme.primaryColor);
        }
      },
      child: Container(
        width: double.infinity, padding: EdgeInsets.all(R.sp(18)),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                        ...
                        return GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Icon(
                              ...
                              color: const Color(0xFFFFD700), size: starSize),
                          ),
                        );
                      }),
                    );
                ...
                SizedBox(height: R.sp(8)),
                Text(
                  selectedStars == 5 ? 'Amazing! ⭐' : selectedStars == 4
                      ? 'Great! 👍' : selectedStars == 3 ? 'Good 👌'
                      : selectedStars == 2 ? 'Fair 😐' : 'Poor 😕',
                  style: GoogleFonts.poppins(fontSize: R.font(15),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    width: double.infinity, height: R.sp(50),
                    decoration: BoxDecoration(
                      gradient: LinearGradient(colors: AppTheme.gradientColors),
                      borderRadius: BorderRadius.circular(R.sp(16)),
                    ),
