...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  Widget _themeOption({
    ...
    return Expanded(
      child: GestureDetector(
        onTap: () {
          setState(() => AppTheme.currentMode = mode);
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            child: Icon(
              AppTheme.currentMode == AppThemeMode.morning
                  ? Icons.wb_sunny_rounded
                  : AppTheme.currentMode == AppThemeMode.afternoon
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                _hoursSlept == 0 ? '--' : _hoursSlept.toStringAsFixed(1),
                style: GoogleFonts.poppins(
                  fontSize: R.font(52),
                  fontWeight: FontWeight.bold,
                  color: Colors.white,
          ...
          Text(
            'Recommended: ${_getRecommendedHours()} hrs for age $_age',
            style: GoogleFonts.poppins(
              fontSize: R.font(11),
  ...
  Widget _buildNavCard({
    ...
    return GestureDetector(
      onTap: onTap,
      child: Container(
        padding: EdgeInsets.symmetric(vertical: R.sp(16), horizontal: R.sp(12)),
        decoration: BoxDecoration(
          color: AppTheme.cardColor,
          borderRadius: BorderRadius.circular(R.sp(20)),
          border: Border.all(color: color.withOpacity(0.3)),
